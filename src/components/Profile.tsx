...
export function Profile({
  ...
  // userId ileride kart (UID vb.) için kullanılacak — şimdilik tutuyoruz
  void userId;
  ...
  return (
    <div className="profile">
      <div className="profile-top">
        <label className="avatar-upload" title="Profil resmi seç">
          {art ? (
            ...
            <span className="avatar-initials">{initials(name || username)}</span>
          )}
      ...
      <div className="account-box">
        ...
        <div className="account-row">
          <label className="account-label">Profil resmi</label>
          <div className="account-field">
        ...
        <div className="account-row">
          ...
          {showPw ? (
            ...
            <div className="account-field">
              <button className="ghost-btn small" onClick={() => setShowPw(true)}>
                Şifre değiştir
              </button>
            </div>
          )}
      ...
      <p className="muted small profile-note">
        Kimlik kartı tasarımı yeniden yapılacak (yeni görsellerle).
      </p>
    </div>
  );
}
