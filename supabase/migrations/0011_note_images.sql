-- TimeNodes — not sayfası görselleri için Storage bucket + RLS politikaları
-- Dosya yolu: note-images/<user_id>/<uuid>.<ext>; herkese açık okuma, sahibine yazma.
-- (0005_avatars.sql desenini izler.)
